...
<<<<<<< HEAD
    ...
    if (isLogin) {
      ...
      if (error) {
        ...
        toast({ title: "Xatolik", description: error.message.includes("Invalid login") ? "Email yoki parol noto'g'ri. Agar hisobingiz yo'q bo'lsa, ro'yxatdan o'ting." : error.message, variant: "destructive" });
...
<<<<<<< HEAD
        ...
        const roleText = role === "specialist" ? "Mutaxassis" : "Mijoz";
        await sendTelegramNotification(`🔔 <b>Yangi ro'yxatdan o'tish!</b>\n\n👤 <b>Ism:</b> ${fullName}\n📧 <b>Email:</b> ${trimmedEmail}\n🎭 <b>Rol:</b> ${roleText}`);
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
      }
    }
