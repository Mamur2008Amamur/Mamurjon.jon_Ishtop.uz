...
<<<<<<< HEAD
const generateRandomSpecialists = () => {
  const roles = ["Santexnik", "Elektrik", "Tozalovchi", "IT mutaxassis", "Ta'mirchi", "O'qituvchi", "Avtomaster", "Fotograf", "Konditsioner", "Go'zallik"];
  const names = ["Azizbek", "Sardor", "Javohir", "Doston", "Shaxzod", "Bekzod", "Umid", "Alisher", "Rustam", "Asror"];
  const lastNames = ["Karimov", "Abdullayev", "Toshmatov", "Eshmatov", "Rahimov", "Olimov", "Nazarov", "Hasanov", "Usmonov", "Qodirov"];
  const regions = [
    { name: "Toshkent", lat: 41.3, lng: 69.2, spread: 0.15 },
    { name: "Samarqand", lat: 39.6, lng: 66.9, spread: 0.1 },
    { name: "Buxoro", lat: 39.7, lng: 64.4, spread: 0.08 },
    { name: "Andijon", lat: 40.7, lng: 72.3, spread: 0.08 },
    { name: "Namangan", lat: 40.9, lng: 71.6, spread: 0.08 },
    { name: "Farg'ona", lat: 40.3, lng: 71.7, spread: 0.08 },
    { name: "Qarshi", lat: 38.8, lng: 65.8, spread: 0.05 },
    { name: "Urganch", lat: 41.5, lng: 60.6, spread: 0.05 },
  ];
  const colors = ["#4F46E5", "#0EA5E9", "#10B981", "#8B5CF6", "#F59E0B", "#EC4899", "#EF4444", "#F97316", "#06B6D4", "#D946EF"];
...
const extendedSpecialists = [...specialists, ...generateRandomSpecialists()];
...
<<<<<<< HEAD
  ...
  const filtered = extendedSpecialists.filter(s =>
=======
...
<<<<<<< HEAD
  const pick = (s: typeof extendedSpecialists[0]) => {
=======
...
<<<<<<< HEAD
          <span className="mb-3 inline-block rounded-full bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary">{t("map_badge")}</span>
          <h2 className="font-display text-3xl font-bold text-foreground md:text-4xl">
            {t("map_title_1")} <span className="text-gradient">{t("map_title_2")}</span>
          </h2>
...
<<<<<<< HEAD
              O'zbekiston — {extendedSpecialists.length} mutaxassis xaritada
=======
