...
<<<<<<< HEAD
    ...
    portfolio: [
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(Buzilgan)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Tamirlangan)", desc: "Eski quvurlarni almashtirish" },
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(Oqayotgan)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Yangi+kran)", desc: "Vannaxona kranini o'rnatish" }
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
    ]
  },
...
<<<<<<< HEAD
    ...
    portfolio: [
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(Chigallashgan+sim)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Tartibli+shchit)", desc: "Elektr shchitni yig'ish" }
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
    ]
  },
...
<<<<<<< HEAD
    ...
    portfolio: [
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(Chang+va+kir)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Yaraqlagan+xona)", desc: "Ta'mirdan keyingi tozalash" }
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
    ]
  },
...
<<<<<<< HEAD
    ...
    portfolio: [
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(Eski+sayt)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Yangi+zamonaviy+sayt)", desc: "Kompaniya veb-saytini yangilash" }
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
    ]
  },
...
<<<<<<< HEAD
    ...
    portfolio: [
      { before: "https://placehold.co/300x200/e2e8f0/475569?text=Oldin+(To'kilib+tushgan+devor)", after: "https://placehold.co/300x200/10b981/ffffff?text=Keyin+(Tekis+va+chiroyli+devor)", desc: "Xona devorlarini gipslash va bo'yash" }
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
    ]
  },
...
<<<<<<< HEAD
const SpecialistProfileModal = ({ s, onClose, onPayment, onBooking, navigate }: any) => (
=======
...
<<<<<<< HEAD
          <Button variant="outline" className="rounded-xl gap-2 h-10" onClick={onBooking}>
            <CheckCircle className="h-4 w-4 text-green-500" /> Buyurtma
          </Button>
=======
>>>>>>> 9e3f45b0ee34d0c9b3b0b17417f24ac9ba002cd8
...
<<<<<<< HEAD
        ...
        {s.portfolio && s.portfolio.length > 0 && (
          <div className="mt-6 border-t pt-4">
            <p className="font-bold text-foreground mb-3 flex items-center gap-2 text-sm">
              <Star className="h-4 w-4 text-primary" /> Portfolio (Oldin va Keyin)
            </p>
            <div className="space-y-4">
              {s.portfolio.map((p: any, idx: number) => (
                <div key={idx} className="rounded-xl border bg-secondary/10 p-3 overflow-hidden">
                  <p className="text-xs font-semibold text-foreground mb-2 text-center">{p.desc}</p>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="relative rounded-lg overflow-hidden border border-border/50">
                      <div className="absolute top-1 left-1 bg-black/60 text-white text-[10px] font-bold px-1.5 py-0.5 rounded backdrop-blur-sm z-10">Oldin</div>
                      <img src={p.before} alt="Oldin" className="w-full h-24 object-cover grayscale-[30%]" />
                    </div>
                    <div className="relative rounded-lg overflow-hidden border border-border/50 border-primary/30 shadow-[0_0_10px_rgba(16,185,129,0.1)]">
                      <div className="absolute top-1 right-1 bg-green-500/80 text-white text-[10px] font-bold px-1.5 py-0.5 rounded backdrop-blur-sm z-10">Keyin</div>
                      <img src={p.after} alt="Keyin" className="w-full h-24 object-cover" />
                    </div>
                  </div>
                </div>
              ))}
...
<<<<<<< HEAD
  ...
  const bookingSpecialist = activeSpec
    ? {
        id: activeSpec.name,
        name: activeSpec.name,
        specialty: activeSpec.role,
        rating: activeSpec.rating,
        reviews: activeSpec.reviews,
        image: activeSpec.portrait,
        price: `${activeSpec.price} so'm`,
        verified: activeSpec.verified,
        responseTime: "~15 min",
        completedJobs: activeSpec.orders,
      }
    : null;
=======
  const [ratingOpen,  setRatingOpen]  = useState(false);
...
<<<<<<< HEAD
            onPayment={() => setPaymentOpen(true)} onBooking={() => { setProfileOpen(null); setBookingOpen(true); }} navigate={navigate} />
        )}
      </AnimatePresence>

      <BookingModal open={bookingOpen} onOpenChange={setBookingOpen} specialist={bookingSpecialist} />
=======
